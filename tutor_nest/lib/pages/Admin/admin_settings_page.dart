...
// // Removed imports related to lessons
// // import 'package:tutor_nest/pages/tutor/history_details_page.dart';
// // import 'package:tutor_nest/pages/tutor/lesson_details_page.dart';
//
...
//           ),
//           const SizedBox(height: 16),
//           // Removed Lesson Report ListTile
//
//           // Privacy Policy
//           ListTile(
...
//   @override
//   Widget build(BuildContext context) {
//     // Implement your Edit Profile Page here
//     return Scaffold(
//       appBar: AppBar(
...
import 'package:flutter/material.dart';
import 'package:tutor_nest/pages/Admin/edit_profile_page.dart';
import '../../services/settings_service.dart'; // Import the service
import '../../widgets/profile_card.dart'; // Import the ProfileCard widget
import '../../models/user_profile.dart'; // Import the UserProfile model
// Removed imports related to lessons
...
// Import for NotificationCreatorPage
// import 'notification_creator_page.dart';
              ...
              if (snapshot.connectionState == ConnectionState.waiting) {
                ...
                return ProfileCard(
                  ...
                  onEditProfile: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => AdminProfileEditPage()),
                    );
